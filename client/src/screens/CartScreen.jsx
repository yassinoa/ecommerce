...
import { Alert, AlertDescription, AlertIcon, AlertTitle, Box, Flex, HStack, Heading, Link, Spinner, Stack, Wrap, useColorModeValue as mode } from "@chakra-ui/react"
    ...
    <Wrap spacing="30px" justify="center"  minHeight='100vh' >
      {loading ? (
        ...
        <Alert status='warning'>
          <AlertIcon />
          <AlertTitle>Your cart is enpmty.</AlertTitle>
          <AlertDescription>
